    ...
    <main class="container px-3" style="max-width: 900px; margin-bottom: 2rem;">
        ...
        <section class="perfil-header card bg-custom rounded-3 text-center mb-4 p-4">
            <form id="editProfileForm" method="POST" action="" enctype="multipart/form-data">
                ...
                <!-- Senha -->
                <div class="mb-4">
                    <label for="senha" class="form-label fw-bold fs-6 text-light mb-2">Nova Senha (opcional)</label>
                    <input type="password" class="form-control form-control-custom fs-6 text-center" id="senha" name="senha" placeholder="Deixe em branco para manter a atual" />
